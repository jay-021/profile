...
An intelligent EdTech platform that ingests medical PDF textbooks, extracts and structures content using AI, and generates adaptive timed quizzes for medical students.
...
#react #typescript #firebase #gemini-ai #edtech #pdf-parsing #fullstack
...
> [!tip] Use this for:
> - **Systems Analyst**: "I designed a data pipeline that transforms unstructured PDFs into a structured quiz database using AI"
> - **Pre-Sales AI Engineer**: "This demonstrates practical LLM API integration — not just prompting, but building production pipelines around AI models"

^medicalbooks-interview
